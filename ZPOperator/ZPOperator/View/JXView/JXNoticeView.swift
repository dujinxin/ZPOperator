...
class JXNoticeView: UIView {
    ...
    func show(inView view:UIView? ,animate:Bool = true) {
        ...
        let rect = msg.boundingRect(with: CGSize.init(width: UIScreen.main.bounds.width - 60, height: CGFloat.greatestFiniteMagnitude), options: [], attributes: attributes, context: nil)
